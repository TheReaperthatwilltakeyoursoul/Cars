...
-- 					TriggerEvent("qb-whitewidow:bill")
-- 				end
...
-- Till Stuff --
RegisterNetEvent("qb-whitewidow:bill")
AddEventHandler("qb-whitewidow:bill", function()
    ...
    if bill ~= nil then
        ...
        TriggerServerEvent("qb-whitewidow:bill:player", bill[1].input, bill[2].input)
    end
end)
...
RegisterNetEvent('qb-whitewidow:PickUpWeed', function()         
	...
	QBCore.Functions.Progressbar("search_register", "Picking Up Weed...", 20000, false, true, {
...
RegisterNetEvent('qb-whitewidow:PickUpWeedSkunk', function()         
	loadAnimDict("anim@amb@business@weed@weed_inspecting_lo_med_hi@")
	TaskPlayAnim(PlayerPedId(), 'anim@amb@business@weed@weed_inspecting_lo_med_hi@', 'weed_spraybottle_crouch_spraying_02_inspector', 8.0, -8, -1, 16, 0, 0, 0, 0, false, false, false)
	QBCore.Functions.Progressbar("search_register", "Picking Up Skunk...", 20000, false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('qb-whitewidow:PickUpWeedAk47', function()         
	loadAnimDict("anim@amb@business@weed@weed_inspecting_lo_med_hi@")
	TaskPlayAnim(PlayerPedId(), 'anim@amb@business@weed@weed_inspecting_lo_med_hi@', 'weed_spraybottle_crouch_spraying_02_inspector', 8.0, -8, -1, 16, 0, 0, 0, 0, false, false, false)
	QBCore.Functions.Progressbar("search_register", "Picking Up AK-47...", 20000, false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent('qb-whitewidow:PickUpWeedOgKush', function()         
	loadAnimDict("anim@amb@business@weed@weed_inspecting_lo_med_hi@")
	TaskPlayAnim(PlayerPedId(), 'anim@amb@business@weed@weed_inspecting_lo_med_hi@', 'weed_spraybottle_crouch_spraying_02_inspector', 8.0, -8, -1, 16, 0, 0, 0, 0, false, false, false)
	QBCore.Functions.Progressbar("search_register", "Picking Up Og-Kush...", 20000, false, true, {
		disableMovement = true,
		disableCarMovement = true,
		disableMouse = false,
		disableCombat = true,
...
RegisterNetEvent("qb-whitewidow:OpenPlate", function()
	TriggerServerEvent("inventory:server:OpenInventory", "stash", "WhiteWidow Tray", {maxweight = 60000, slots = 50})
	TriggerEvent("inventory:client:SetCurrentStash", "WhiteWidow Tray") 
end)

RegisterNetEvent("qb-taco:OpenPlateee", function()
	TriggerServerEvent("inventory:server:OpenInventory", "stash", "Taco Tray", {maxweight = 60000, slots = 50})
	TriggerEvent("inventory:client:SetCurrentStash", "Taco Tray") 
end)

RegisterNetEvent("qb-yellowjack:OpenPlateee", function()
	TriggerServerEvent("inventory:server:OpenInventory", "stash", "Yellow Jack Tray", {maxweight = 60000, slots = 50})
	TriggerEvent("inventory:client:SetCurrentStash", "Yellow Jack Tray") 
end)
...
RegisterNetEvent("qb-white:stashh")
AddEventHandler("qb-white:stashh", function()
    TriggerEvent("inventory:client:SetCurrentStash", "WhiteWidowStash")
    TriggerServerEvent("inventory:server:OpenInventory", "stash", "WhiteWidowStash", {
        maxweight = 350000,
        slots = 30,
    })
end)
...
CreateThread(function()
	local Player = QBCore.Functions.GetPlayerData()
		--// Shop Target \\--
		exports['qb-target']:AddBoxZone("WhiteWidowShopMenu", vector3(185.3743, -242.22, 54.12888), 2.2, 2.2, {
...
function ProcessJoints()
	...
	QBCore.Functions.Progressbar("search_register", "Rolling Joints...", 18000, false, true, {
	  	disableMovement = true,
	  	disableCarMovement = true,
	  	disableMouse = false,
		disableCombat = true,
